...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity> implements CategoryBrandRelationService {
    ...
    @Autowired
    CategoryBrandRelationDao categoryBrandRelationDao;//与this.basemapper()等价
    @Autowired
    ...
    public void updateBrand(Long brandId, String name) {
        ...
        UpdateWrapper<CategoryBrandRelationEntity> updateWrapper = new UpdateWrapper<CategoryBrandRelationEntity>().eq("brand_id", brandId);//更新的wrapper为updateWrapper
        this.update(categoryBrandRelationEntity, updateWrapper);
    }

    @Override
    public void updateCategory(Long catId, String name) {
        // 可以采用updateBrand同样的方法创造构造器去更新，这里采用了编写自定义sql的方法
